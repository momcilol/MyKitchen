...
public class RecipeInformation {
    ...
    public RecipeInformation(boolean vegetarian, boolean vegan, boolean glutenFree, boolean dairyFree,
                             boolean veryHealthy, boolean cheap, boolean veryPopular, boolean sustainable,
                             int weightWatcherSmartPoints, String gaps, boolean lowFodmap, int aggregateLikes,
                             double spoonacularScore, double healthScore, String creditsText, String license,
                             String sourceName, double pricePerServing, List<ExtendedIngredient> extendedIngredients,
                             int id, String title, int readyInMinutes, int servings, String sourceUrl, String image,
                             String imageType, String summary, List<Object> cuisines, List<String> dishTypes,
                             List<Object> diets, List<Object> occasions, WinePairing winePairing, String instructions,
                             List<Object> analyzedInstructions, Object originalId, String spoonacularSourceUrl) {
        super();
